...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "http://192.168.1.105/ionic_cart_php/food_menu.php?till=";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str="http://192.168.1.105/ionic_cart_php/food_menu.php?till="+obj.till; // pass the value to url
